...
<head>
    ...
    <link href=" <?= base_url('assets/styleBerita/css/bootstrap.min.css') ?>" rel="stylesheet">
    <link href=" <?= base_url('assets/styleBerita/css/fontawesome-all.min.css') ?> " rel="stylesheet">
    <link href=" <?= base_url('assets/styleBerita/css/swiper.css') ?> " rel="stylesheet">
    <link href=" <?= base_url('assets/styleBerita/css/styles.css') ?> " rel="stylesheet">
...
<body>
    ...
    <!-- Scripts -->
    <script src=" <?= base_url('assets/styleBerita/js/bootstrap.min.js') ?> "></script>
    <!-- Bootstrap framework -->
    <script src=" <?= base_url('assets/styleBerita/js/swiper.min.js') ?> "></script>
    <!-- Swiper for image and text sliders -->
    <script src=" <?= base_url('assets/styleBerita/js/purecounter.min.js') ?> "></script>
    <!-- Purecounter counter for statistics numbers -->
    <script src=" <?= base_url('assets/styleBerita/js/isotope.pkgd.min.js') ?> "></script>
    <!-- Isotope for filter -->
    <script src=" <?= base_url('assets/styleBerita/js/scripts.js') ?> "></script>
    <!-- Custom scripts -->
</body>
